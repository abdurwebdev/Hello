...
const ShopHero = () => {
  return (
    ...
    <div className='relative'>
        ...
        <h1 id={style.main} className='font-[Raleway] font-extrabold text-white text-4xl'>Shop</h1>
        ...
        <Link href='/Shop' className='hover:text-[#ffffff] text-[#81C408] transition-colors'>Shop</Link>
        </div>
