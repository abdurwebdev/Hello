...
const ShopHero = () => {
  return (
    ...
    <div className='relative'>
        ...
        <h1 id={style.main} className='font-[Raleway] font-extrabold text-white text-4xl'>Cart</h1>
        ...
        <Link href='/Shop' className='hover:text-[#ffffff] text-[#81C408] transition-colors'>Cart</Link>
        </div>
