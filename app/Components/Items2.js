  ...
  return (
    ...
    {/* First Item Start */}
     <div className='flex items-center text-nowrap'>
        <img className='rounded-lg w-[100px] h-[70px]' src='https://images.unsplash.com/photo-1518977676601-b53f82aba655?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'/>
